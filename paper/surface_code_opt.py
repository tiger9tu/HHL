...
if __name__ == "__main__":
    ...
    for n in range(10, 50):
        logical_qubit_count = n + 20  # suppose HHL's ancilla qubits are 20
        # t_gate_count =

    for scale in range(1, 10):
        t_gate_count = np.exp(scale)
        (
            optimal_distillation_block_count,
            optimal_data_protocol,
            optimal_cycle_count,
    ...
    #     f"optimal data protocol: {optimal_data_protocol}, optimal time: {optimal_cycle_count * clock_cycle_time}s,",
